...
describe("Handle alert check boc in js",()=>{
    ...
    it("Validate js confirm alert box work correctly on click ok ",()=>{
       ...
       // you get alert message  press a button ok 
        cy.on('window:alert',(str) => {
            return true;//It meance you click on ok buttons
           
            // return false;
           //it meanec you click on cancle button
        })
    ...
    it("Validate js confirm alert box using stub ",()=>{
        ...
        //you can use another promise
        // this is like window alert return true for ok and false for cancle.
