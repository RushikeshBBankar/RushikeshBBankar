...
beforeEach(() => {
    ...
    it("eq() To retrive a specific element based on Index",()=>{
    ...
    it("find() to retrive Dom element of a given selectors",()=>{
    ...
    it("prev() To get privious sibling DOM element withn elemt",() =>{
